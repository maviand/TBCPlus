...
const TheArmory = () => {
        ...
        return text.split('\n').map((line, i) => (
            <p key={i} className="mb-2 text-stone-400 text-sm leading-relaxed">
                {line.split(/(\*\*.*?\*\*)/g).map((part, j) =>
                    part.startsWith('**') ? <strong key={j} className="text-[#ffd100] font-normal">{part.slice(2, -2)}</strong> : part
                )}
            </p>
        ));
    };
    ...
    const tiers = [
        { id: 't4', label: 'Tier 4', sub: 'Karazhan / Gruul / Mag' },
        { id: 't5', label: 'Tier 5', sub: 'SSC / The Eye' },
        { id: 't6', label: 'Tier 6', sub: 'Hyjal / Black Temple' },
        { id: 't6.5', label: 'Tier 6.5', sub: 'Sunwell / Citadel' },
        { id: 't1', label: 'Tier 1', sub: 'Time-Lost (MC)' },
        { id: 't2', label: 'Tier 2', sub: 'Time-Lost (BWL)' },
        { id: 't3', label: 'Tier 3', sub: 'Time-Lost (Naxx)' },
    ];
            ...
            specs: [
                {
                    ...
                    sets: {
                        t4: { name: 'Justicar Armor', image: 'https://imgur.com/7j4Z1wK.jpeg', bonus: '**2-Set:** Increases the healing delivered by your Holy Light spell by 10%.\n**4-Set:** Reduces the cooldown on your Illumination talent by 3 minutes.' },
                        t5: { name: 'Crystalforge Armor', image: 'https://imgur.com/7j4Z1wK.jpeg', bonus: '**2-Set:** Reduces the cost of your Holy Light spell by 10%.\n**4-Set:** Your critical heals from Flash of Light reduce the cast time of your next Holy Light spell by 0.50 sec for 10 sec.' },
                        t6: { name: 'Lightbringer Armor', image: 'https://imgur.com/7j4Z1wK.jpeg', bonus: '**2-Set:** Increases the critical effect chance of your Holy Light spell by 5%.\n**4-Set:** Increases the healing done by your Flash of Light spell by 5%.' },
                        ...
                        t1: { name: 'Lawbringer Armor (Reforged)', image: 'https://imgur.com/7j4Z1wK.jpeg', bonus: '**2-Set:** **Daybreak:** Holy Shock cooldown reduced by 2 seconds.\n**4-Set:** **Glimmer of Light:** Holy Shock leaves a "Glimmer" on the target. Your next Holy Light heals all Glimmered targets for 20% of the amount.' },
                        t2: { name: 'Judgement Armor (Reforged)', image: 'https://imgur.com/7j4Z1wK.jpeg', bonus: '**2-Set:** **Rule of Law:** Mastery: Increases the range of your heals and the radius of your auras by 50%.\n**4-Set:** **Judgement of Light:** Judgement heals the 3 most injured nearby allies.' },
                        t3: { name: 'Redemption Armor (Reforged)', image: 'https://imgur.com/7j4Z1wK.jpeg', bonus: '**2-Set:** **Awakening:** Word of Glory (HP Spender) has a 15% chance to grant you "Avenging Wrath" for 8 seconds.\n**4-Set:** **Beacon of Virtue:** Beacon of Light now copies 100% of healing to the Beacon target.' }
                    }
                },
                {
                    name: 'Protection',
                    ...
                    sets: {
                        t4: { name: 'Justicar Armor', image: 'https://imgur.com/7j4Z1wK.jpeg', bonus: '**2-Set:** Increases the damage dealt by your Consecration spell by 15%.\n**4-Set:** Increases the damage dealt by your Holy Shield ability by 15%.' },
                        t5: { name: 'Crystalforge Armor', image: 'https://imgur.com/7j4Z1wK.jpeg', bonus: '**2-Set:** 20% of all damage taken is applied over 12 seconds instead of instantly.\n**4-Set:** Your Judgement ability now also taunts the target to attack you.' },
                        t6: { name: 'Lightbringer Armor', image: 'https://imgur.com/7j4Z1wK.jpeg', bonus: '**2-Set:** Increases the mana gained from your Spiritual Attunement ability by 10%.\n**4-Set:** Increases the damage dealt by your Consecration spell by 10%.' },
                        ...
                        t1: { name: 'Lawbringer Battlegear (Reforged)', image: 'https://imgur.com/7j4Z1wK.jpeg', bonus: '**2-Set:** **Blessed Hammer:** Hammer of the Righteous spirals outward, reducing enemy damage dealt by 10%.\n**4-Set:** **Bulwark of Order:** Avenger\'s Shield grants you an absorption shield equal to 100% of damage dealt.' },
                        t2: { name: 'Judgement Battlegear (Reforged)', image: 'https://imgur.com/7j4Z1wK.jpeg', bonus: '**2-Set:** **Grand Crusader:** Avenger\'s Shield has a 15% chance to reset its cooldown when you avoid an attack.\n**4-Set:** **Divine Toll:** Judgement casts 3 extra hammers at nearby enemies.' },
                        t3: { name: 'Redemption Battlegear (Reforged)', image: 'https://imgur.com/7j4Z1wK.jpeg', bonus: '**2-Set:** **Final Stand:** Divine Shield requires a defensive stance but taunts all enemies within 15 yards.\n**4-Set:** **Eye of Tyr:** Flash of Light is instant cast and costs no mana after a Shield of the Righteous crit.' }
                    }
                },
                {
                    name: 'Retribution',
                    ...
                    sets: {
                        t4: { name: 'Justicar Battlegear', image: 'https://imgur.com/7j4Z1wK.jpeg', bonus: '**2-Set:** Increases the damage dealt by your Crusader Strike ability by 10%.\n**4-Set:** Increases the damage dealt by your Judgement abilities by 10%.' },
                        t5: { name: 'Crystalforge Battlegear', image: 'https://imgur.com/7j4Z1wK.jpeg', bonus: '**2-Set:** Your Judgement abilities have a chance to restore 50 mana to your party members.\n**4-Set:** Your Hammer of Justice hits 100% harder.' },
                        t6: { name: 'Lightbringer Battlegear', image: 'https://imgur.com/7j4Z1wK.jpeg', bonus: '**2-Set:** Your melee attacks have a chance to restore 50 mana.\n**4-Set:** Increases the damage dealt by your Hammer of Wrath ability by 10%.' },
                        ...
                        t1: { name: 'Lawbringer Plate (Reforged)', image: 'https://imgur.com/7j4Z1wK.jpeg', bonus: '**2-Set:** **Blade of Justice:** Art of War makes your next Exorcism reset the cooldown of Divine Storm.\n**4-Set:** **Zeal:** Crusader Strike hits twice.' },
                        t2: { name: 'Judgement Plate (Reforged)', image: 'https://imgur.com/7j4Z1wK.jpeg', bonus: '**2-Set:** **Empyrean Legacy:** Divine Storm projects a wave of light forward, dealing Holy damage.\n**4-Set:** **Final Verdict:** Templar\'s Verdict (HP Spender) has a 15% chance to make your next Hammer of Wrath usable on any target.' },
                        t3: { name: 'Redemption Plate (Reforged)', image: 'https://imgur.com/7j4Z1wK.jpeg', bonus: '**2-Set:** **Ashes to Ashes:** Wake of Ashes (New Ability) replaces Consecration. Strikes enemies for massive Holy damage and generates 3 Holy Power.\n**4-Set:** **Crusade:** Avenging Wrath grants +3% Haste for each Holy Power spent.' }
                    }
                }
            ]
        },
            ...
            specs: [
                {
                    ...
                    sets: {
                        t4: { name: 'Demon Stalker Armor', image: 'https://imgur.com/xX9A1wK.jpeg', bonus: '**2-Set:** Reduces the chance your Feign Death ability will be resisted by 5%.\n**4-Set:** Reduces the cooldown of your Kill Command ability by 2 sec.' },
                        t5: { name: 'Rift Stalker Armor', image: 'https://imgur.com/xX9A1wK.jpeg', bonus: '**2-Set:** Your pet heals for 15% of the damage you deal.\n**4-Set:** Your Steady Shot ability has a 5% chance to grant you 20% attack power for 10 sec.' },
                        t6: { name: 'Gronnstalker\'s Armor', image: 'https://imgur.com/xX9A1wK.jpeg', bonus: '**2-Set:** Increases the mana restored by your Aspect of the Viper by an additional 5%.\n**4-Set:** Increases the damage dealt by your Steady Shot ability by 10%.' },
                        ...
                        t1: { name: 'Giantstalker Harness (Reforged)', image: 'https://imgur.com/xX9A1wK.jpeg', bonus: '**2-Set:** **Cobra Strikes:** Kill Command criticals reset the cooldown of Kill Shot.\n**4-Set:** **Dire Beast:** Steady Shot has a 10% chance to summon a Dire Beast to fight for you for 8 sec.' },
                        t2: { name: 'Dragonstalker Harness (Reforged)', image: 'https://imgur.com/xX9A1wK.jpeg', bonus: '**2-Set:** **Bestial Strength:** Your Pet deals 15% increased damage while under the effects of Bestial Wrath.\n**4-Set:** **Call of the Wild:** All your stable pets are summoned to fight for 12 seconds (3 min CD).' },
                        t3: { name: 'Cryptstalker Harness (Reforged)', image: 'https://imgur.com/xX9A1wK.jpeg', bonus: '**2-Set:** **Pack Leader:** Kill Command has 2 charges.\n**4-Set:** **Titanspar:** Barbed Shot applies a "Lacerating Wound" that increases pet damage by 5%, stacking 3 times.' }
                    }
                },
                {
                    name: 'Marksmanship',
                    ...
                    sets: {
                        ...
                        t1: { name: 'Giantstalker Armor (Reforged)', image: 'https://imgur.com/xX9A1wK.jpeg', bonus: '**2-Set:** **Eagle Eye:** Range of all shots increased by 5 yards.\n**4-Set:** **Dead Eye:** Aimed Shot cast time reduced by 50%.' },
                        t2: { name: 'Dragonstalker Armor (Reforged)', image: 'https://imgur.com/xX9A1wK.jpeg', bonus: '**2-Set:** **Rapid Killing:** Killing an enemy resets the cooldown of Rapid Fire.\n**4-Set:** **Windburst:** Aimed Shot leaves a wind trail, increasing movement speed of allies by 40%.' },
                        t3: { name: 'Cryptstalker Armor (Reforged)', image: 'https://imgur.com/xX9A1wK.jpeg', bonus: '**2-Set:** **Dark Ranger:** Black Arrow now silences the target for 3 sec.\n**4-Set:** **Wailing Arrow:** Chimera Shot splashes shadow damage to all enemies within 8 yards.' }
                    }
                },
                {
                    name: 'Survival',
                    ...
                    sets: {
                        ...
                        t1: { name: 'Giantstalker Guise (Reforged)', image: 'https://imgur.com/xX9A1wK.jpeg', bonus: '**2-Set:** **Wildfire:** Explosive Trap burns enemies for 20% more damage.\n**4-Set:** **Hydra\'s Bite:** Serpent Sting shoots arrows at 2 additional nearby targets.' },
                        t2: { name: 'Dragonstalker Guise (Reforged)', image: 'https://imgur.com/xX9A1wK.jpeg', bonus: '**2-Set:** **Wyvern Sting:** Cooldown reduced by 30 sec, and now deals high Nature damage over time.\n**4-Set:** **Viper\'s Venom:** Mongoose Bite has a 30% chance to reset the cooldown of Explosive Shot.' },
                        t3: { name: 'Cryptstalker Guise (Reforged)', image: 'https://imgur.com/xX9A1wK.jpeg', bonus: '**2-Set:** **Camouflage:** You heal for 5% of your max health every sec while in Camouflage (Stealth).\n**4-Set:** **Butchery:** Carve (Melee AoE) reduces the cooldown of your Wildfire Bomb by 1 sec for each target hit.' }
                    }
                }
            ]
        },
            ...
            specs: [
                {
                    ...
                    sets: {
                        t4: { name: 'Netherblade Breeches', image: 'https://imgur.com/yY9B1wK.jpeg', bonus: '**2-Set:** Increases the duration of your Slice and Dice ability by 3 sec.\n**4-Set:** Your finishing moves have a 15% chance to grant you an extra combo point.' },
                        t5: { name: 'Deathmantle Legguards', image: 'https://imgur.com/yY9B1wK.jpeg', bonus: '**2-Set:** Your Eviscerate and Envenom abilities deal 40 additional damage per combo point.\n**4-Set:** Your attacks have a chance to make your next finishing move cost no energy.' },
                        t6: { name: 'Slayer\'s Legguards', image: 'https://imgur.com/yY9B1wK.jpeg', bonus: '**2-Set:** Increases the haste from your Slice and Dice ability by 5%.\n**4-Set:** Increases the damage dealt by your Backstab, Sinister Strike, Mutilate, and Hemorrhage abilities by 6%.' },
                        ...
                        t1: { name: 'Nightslayer Tunic (Reforged)', image: 'https://imgur.com/yY9B1wK.jpeg', bonus: '**2-Set:** **Master Poisoner:** Mutilate costs 10 less Energy.\n**4-Set:** **System Shock:** Envenom critical strikes silence the target for 1.5 sec (6 sec internal CD).' },
                        t2: { name: 'Bloodfang Tunic (Reforged)', image: 'https://imgur.com/yY9B1wK.jpeg', bonus: '**2-Set:** **Toxic Blade:** Shiv now applies 2 stacks of Deadly Poison.\n**4-Set:** **Kingsbane:** Vendetta applies a lethal poison, dealing massive nature damage over 12 seconds.' },
                        t3: { name: 'Bonescythe Tunic (Reforged)', image: 'https://imgur.com/yY9B1wK.jpeg', bonus: '**2-Set:** **Blindside:** Envenom has a 20% chance to reset the cooldown of Mutilate.\n**4-Set:** **Sudden Demise:** Your Bleed ticks have a chance to deal instant Nature damage based on your Attack Power.' }
                    }
                },
                {
                    name: 'Combat',
                    ...
                    sets: {
                        ...
                        t1: { name: 'Nightslayer Chestpiece (Reforged)', image: 'https://imgur.com/yY9B1wK.jpeg', bonus: '**2-Set:** **Blade Flurry:** Blade Flurry now has 2 charges.\n**4-Set:** **Adrenaline:** Adrenaline Rush lasts 5 seconds longer.' },
                        t2: { name: 'Bloodfang Chestpiece (Reforged)', image: 'https://imgur.com/yY9B1wK.jpeg', bonus: '**2-Set:** **Broadsides:** Sinister Strike has a 20% chance to generate an additional Combo Point.\n**4-Set:** **Roll the Bones:** Finishing moves grant a random combat enhancement for 10 sec (Crit, Haste, or Energy Regen).' },
                        t3: { name: 'Bonescythe Chestpiece (Reforged)', image: 'https://imgur.com/yY9B1wK.jpeg', bonus: '**2-Set:** **Revealing Strike:** Sinister Strike increases the damage of your next Eviscerate by 10%.\n**4-Set:** **Killing Spree:** Killing Spree grants you total immunity to all damage and effects while active.' }
                    }
                },
                {
                    name: 'Subtlety',
                    ...
                    sets: {
                        ...
                        t1: { name: 'Nightslayer Vest (Reforged)', image: 'https://imgur.com/yY9B1wK.jpeg', bonus: '**2-Set:** **Shadowstrike:** Ambush teleports you to your target (25 yd range).\n**4-Set:** **First Blood:** Eviscerate deals 50% increased damage to targets below 35% health.' },
                        t2: { name: 'Bloodfang Vest (Reforged)', image: 'https://imgur.com/yY9B1wK.jpeg', bonus: '**2-Set:** **Shadow Techniques:** Auto-attacks have a chance to generate Combo Points.\n**4-Set:** **Secret Technique:** Eviscerate creates a shadow clone that mimics your finisher.' },
                        t3: { name: 'Bonescythe Vest (Reforged)', image: 'https://imgur.com/yY9B1wK.jpeg', bonus: '**2-Set:** **Envelope of Shadows:** Vanish grants you a shield absorbing 30% of your max health.\n**4-Set:** **Akaari\'s Soul:** Shadowstrike (Ambush) leaves a soul fragment on the target that explodes for Shadow damage after 2 seconds.' }
                    }
                }
            ]
        },
            ...
            specs: [
                {
                    ...
                    sets: {
                        t4: { name: 'Incarnate Regalia', image: 'https://imgur.com/zZ9C1wK.jpeg', bonus: '**2-Set:** Your Prayer of Healing spell now heals for an additional 150.\n**4-Set:** Your Flash Heal spell has a chance to cause your next Flash Heal to be instant cast.' },
                        t5: { name: 'Avatar Regalia', image: 'https://imgur.com/zZ9C1wK.jpeg', bonus: '**2-Set:** If your Greater Heal brings the target to full health, you gain 100 mana.\n**4-Set:** Your Renew spell lasts 3 sec longer.' },
                        t6: { name: 'Absolution Regalia', image: 'https://imgur.com/zZ9C1wK.jpeg', bonus: '**2-Set:** Reduces the mana cost of your Prayer of Healing by 10%.\n**4-Set:** Your Greater Heal has a chance to heal your target for 334 mana.' },
                        ...
                        t1: { name: 'Prophecy Robe (Reforged)', image: 'https://imgur.com/zZ9C1wK.jpeg', bonus: '**2-Set:** **Penance:** Penance channel time reduced by 0.5 sec.\n**4-Set:** **Power of the Dark Side:** Penance has a chance to deal 50% increased damage/healing.' },
                        t2: { name: 'Transcendence Robe (Reforged)', image: 'https://imgur.com/zZ9C1wK.jpeg', bonus: '**2-Set:** **Atonement:** Power Word: Shield reflects 30% of damage absorbed as Holy damage.\n**4-Set:** **Barrier:** Power Word: Barrier grants immunity to interrupts while inside.' },
                        t3: { name: 'Faith Robe (Reforged)', image: 'https://imgur.com/zZ9C1wK.jpeg', bonus: '**2-Set:** **Rapture:** When your Power Word: Shield is fully absorbed, you instantly regenerate 2% mana.\n**4-Set:** **Spirit Shell:** Power Infusion also wraps the target in a Spirit Shell, absorbing massive damage for 15 sec.' }
                    }
                },
                {
                    name: 'Holy',
                    ...
                    sets: {
                        ...
                        t1: { name: 'Prophecy Vestments (Reforged)', image: 'https://imgur.com/zZ9C1wK.jpeg', bonus: '**2-Set:** **Serendipity:** Flash Heal reduces the cast time of your next Greater Heal by 20% (Stacks 2x).\n**4-Set:** **Guardian Spirit:** Guardian Spirit cooldown reduced by 60 sec.' },
                        t2: { name: 'Transcendence Vestments (Reforged)', image: 'https://imgur.com/zZ9C1wK.jpeg', bonus: '**2-Set:** **Echo of Light:** Your direct heals leave a HoT for 10% of the amount healed.\n**4-Set:** **Apotheosis:** Reset the cooldown of all Holy Words and enter a pure Holy form for 10 sec.' },
                        t3: { name: 'Faith Vestments (Reforged)', image: 'https://imgur.com/zZ9C1wK.jpeg', bonus: '**2-Set:** **Light of Naaru:** Holy Word: Serenity reduces the cooldown of Circle of Healing by 2 sec.\n**4-Set:** **Salvation:** Divine Hymn is now castable while moving and heals for 20% more.' }
                    }
                },
                {
                    name: 'Shadow',
                    ...
                    sets: {
                        t4: { name: 'Incarnate Raiment', image: 'https://imgur.com/zZ9C1wK.jpeg', bonus: '**2-Set:** Your Shadowfiend lasts 3 sec longer.\n**4-Set:** Your Mind Flay spell deals 5% more damage.' },
                        t5: { name: 'Avatar Raiment', image: 'https://imgur.com/zZ9C1wK.jpeg', bonus: '**2-Set:** Each time you cast a Shadow spell, you have a chance to gain 132 Spell Power for 15 sec.\n**4-Set:** Your Shadow Word: Pain deals 12% more damage.' },
                        t6: { name: 'Absolution Raiment', image: 'https://imgur.com/zZ9C1wK.jpeg', bonus: '**2-Set:** Increases the duration of your Shadow Word: Pain by 3 sec.\n**4-Set:** Increases the damage of your Mind Blast by 10%.' },
                        ...
                        t1: { name: 'Prophecy Shroud (Reforged)', image: 'https://imgur.com/zZ9C1wK.jpeg', bonus: '**2-Set:** **Voidform:** Mind Blast reduces the cast time of Vampiric Touch by 50%.\n**4-Set:** **Void Origins:** Erupting into Voidform (Shadowform) deals Shield damage to all enemies within 10yds.' },
                        t2: { name: 'Transcendence Shroud (Reforged)', image: 'https://imgur.com/zZ9C1wK.jpeg', bonus: '**2-Set:** **Shadowy Insights:** Shadow Word: Pain ticks have a chance to reset the cooldown of Mind Blast.\n**4-Set:** **Void Shift:** Swap health percentages with your Shadowfiend, effectively fully healing you when it dies or expires.' },
                        t3: { name: 'Faith Shroud (Reforged)', image: 'https://imgur.com/zZ9C1wK.jpeg', bonus: '**2-Set:** **Call to the Void:** Mind Flay has a chance to spawn a Void Tentacle that channels at your target.\n**4-Set:** **Surrender to Madness:** Movement speed increased by 30% while in Shadowform. You can cast while moving for 10 sec after using Dispersion.' }
                    }
                }
            ]
        },
            ...
            specs: [
                {
                    ...
                    sets: {
                        t4: { name: 'Cyclone Regalia', image: 'https://imgur.com/aA9D1wK.jpeg', bonus: '**2-Set:** Your Wrath of Air Totem grants an additional 20 spell power.\n**4-Set:** Your Lightning Bolt critical strikes have a chance to grant 120 mana to all party members.' },
                        t5: { name: 'Cataclysm Regalia', image: 'https://imgur.com/aA9D1wK.jpeg', bonus: '**2-Set:** Reduces the cost of your Chain Lightning spell by 10%.\n**4-Set:** Your Lightning Bolt critical strikes have a chance to reduce the cast time of your next Lightning Bolt by 0.5 sec.' },
                        t6: { name: 'Skyshatter Regalia', image: 'https://imgur.com/aA9D1wK.jpeg', bonus: '**2-Set:** Reduces the mana cost of your Lightning Bolt, Chain Lightning, and Lightning Shield spells by 10%.\n**4-Set:** Increases the damage done by your Lightning Bolt by 5%.' },
                        ...
                        t1: { name: 'Earthfury Regalia (Reforged)', image: 'https://imgur.com/aA9D1wK.jpeg', bonus: '**2-Set:** **Echo of the Elements:** Lava Burst has 2 charges.\n**4-Set:** **Master of the Elements:** Casting Lava Burst increases your Nature damage by 10% for 10 sec.' },
                        t2: { name: 'Ten Storms Regalia (Reforged)', image: 'https://imgur.com/aA9D1wK.jpeg', bonus: '**2-Set:** **Stormkeeper:** Your next 2 Lightning Bolts are instant cast and overload (1.5m CD).\n**4-Set:** **Unlimited Power:** Lightning Overloads generate mana.' },
                        t3: { name: 'Earthshatter Regalia (Reforged)', image: 'https://imgur.com/aA9D1wK.jpeg', bonus: '**2-Set:** **Primordial Wave:** Flame Shock hits 1 additional target.\n**4-Set:** **Ascendance:** Transform into a Flame Ascendant for 15 sec, replacing Chain Lightning with Lava Beam (no CD).' }
                    }
                },
                {
                    name: 'Enhancement',
                    ...
                    sets: {
                        t4: { name: 'Cyclone Harness', image: 'https://imgur.com/aA9D1wK.jpeg', bonus: '**2-Set:** Your Strength of Earth Totem grants an additional 12 strength.\n**4-Set:** Your Stormstrike ability deals an additional 30 damage per weapon.' },
                        t5: { name: 'Cataclysm Harness', image: 'https://imgur.com/aA9D1wK.jpeg', bonus: '**2-Set:** Your melee attacks have a chance to increase your haste by 10% for 10 sec.\n**4-Set:** Your Stormstrike ability deals 30% more damage if you are dual-wielding.' },
                        t6: { name: 'Skyshatter Harness', image: 'https://imgur.com/aA9D1wK.jpeg', bonus: '**2-Set:** Your Earth Shock, Flame Shock, and Frost Shock abilities cost 10% less mana.\n**4-Set:** Increases the attack power bonus from your Stormstrike ability by an additional 70.' },
                        ...
                        t1: { name: 'Earthfury Harness (Reforged)', image: 'https://imgur.com/aA9D1wK.jpeg', bonus: '**2-Set:** **Hailstorm:** Frost Shock damage increased by 50%.\n**4-Set:** **Ice Strike:** Stormstrike resets the cooldown of your Frost and Earth Shocks.' },
                        t2: { name: 'Ten Storms Harness (Reforged)', image: 'https://imgur.com/aA9D1wK.jpeg', bonus: '**2-Set:** **Crash Lightning:** Crash Lightning (Cone AoE) replaces Chain Lightning. Enhances your weapons to cleave on all attacks.\n**4-Set:** **Stormbringer:** Stormstrike has a chance to reset its own cooldown.' },
                        t3: { name: 'Earthshatter Harness (Reforged)', image: 'https://imgur.com/aA9D1wK.jpeg', bonus: '**2-Set:** **Doom Winds:** Windfury Weapon has a 100% chance to trigger for 6 seconds (1m CD).\n**4-Set:** **Sundering:** Earth Shock creates a fissure, dealing Flamestrike damage to enemies in a line.' }
                    }
                },
                {
                    name: 'Restoration',
                    ...
                    sets: {
                        t4: { name: 'Cyclone Raiment', image: 'https://imgur.com/aA9D1wK.jpeg', bonus: '**2-Set:** Reduces the cooldown of your Nature\'s Swiftness ability by 24 sec.\n**4-Set:** Increases the healing gained from your Healing Stream Totem ability.' },
                        t5: { name: 'Cataclysm Raiment', image: 'https://imgur.com/aA9D1wK.jpeg', bonus: '**2-Set:** Your Lesser Healing Wave has a chance to restore 120 mana to you.\n**4-Set:** Your Chain Heal critical heals have a chance to increase the healing of your next Lesser Healing Wave by 25%.' },
                        t6: { name: 'Skyshatter Raiment', image: 'https://imgur.com/aA9D1wK.jpeg', bonus: '**2-Set:** Your Chain Heal ability costs 10% less mana.\n**4-Set:** Increases the healing done by your Lesser Healing Wave ability by 5%.' },
                        ...
                        t1: { name: 'Earthfury Raiment (Reforged)', image: 'https://imgur.com/aA9D1wK.jpeg', bonus: '**2-Set:** **Cloudburst:** Healing Stream Totem stores 10% of all healing you do and releases it when it expires.\n**4-Set:** **High Tide:** Chain Heal no longer reduces in potency with each bounce.' },
                        t2: { name: 'Ten Storms Raiment (Reforged)', image: 'https://imgur.com/aA9D1wK.jpeg', bonus: '**2-Set:** **Echo of the Elements:** Riptide has 2 charges.\n**4-Set:** **Primordial Wave:** Apply Riptide to all party members (45s CD).' },
                        t3: { name: 'Earthshatter Raiment (Reforged)', image: 'https://imgur.com/aA9D1wK.jpeg', bonus: '**2-Set:** **Wellspring:** Chain Heal leaves a "Riptide" HoT on the primary target.\n**4-Set:** **Spirit Link:** Spirit Link Totem reduces damage taken by all party members by 10%.' }
                    }
                }
            ]
        },
            ...
            specs: [
                {
                    ...
                    sets: {
                        t4: { name: 'Aldor Regalia', image: 'https://imgur.com/bB9E1wK.jpeg', bonus: '**2-Set:** Spells cast while in the Clearcasting state have 30% increased critical strike chance.\n**4-Set:** Your critical strikes have a chance to increase your spell power by 50 for 12 sec.' },
                        t5: { name: 'Tirisfal Regalia', image: 'https://imgur.com/bB9E1wK.jpeg', bonus: '**2-Set:** Increases the damage and mana cost of your Arcane Blast by 20%.\n**4-Set:** Your Spell critical strikes grant you up to 70 spell power for 6 sec.' },
                        t6: { name: 'Tempest Regalia', image: 'https://imgur.com/bB9E1wK.jpeg', bonus: '**2-Set:** Increases the duration of your Evocation ability by 2 sec.\n**4-Set:** Increases the damage of your Fireball, Frostbolt, and Arcane Missiles abilities by 5%.' },
                        't6.5': { name: 'Regalia of the Arcane Order', image: 'https://i.imgur.com/ZmtFvSD.jpeg', bonus: '**2-Set:** Presence of Mind cooldown reduced by 30 sec.\n**4-Set:** Arcane Power damage bonus increased to 40%.' },
                        t1: { name: 'Arcanist Regalia (Reforged)', image: 'https://imgur.com/bB9E1wK.jpeg', bonus: '**2-Set:** **Arcane Flux:** Arcane Blast cast time reduced by 0.2 sec.\n**4-Set:** **Time Anomaly:** Casting Arcane Missiles has a chance to grant "Time Warp" to yourself for 6 seconds.' },
                        t2: { name: 'Netherwind Regalia (Reforged)', image: 'https://imgur.com/bB9E1wK.jpeg', bonus: '**2-Set:** **Touch of the Magi:** Arcane Power applies Touch of the Magi, accumulating 20% of damage dealt and exploding when it expires.\n**4-Set:** **Slipstream:** Arcane Missiles can be channeled while moving.' },
                        t3: { name: 'Frostfire Regalia (Reforged)', image: 'https://imgur.com/bB9E1wK.jpeg', bonus: '**2-Set:** **Arcane Harmony:** Arcane Missiles stacks "Harmony", increasing the damage of your next Arcane Barrage by 10% per stack (up to 20).\n**4-Set:** **Radiant Spark:** Your next 4 spells deal 10%, 20%, 30%, and 40% increased damage (45s CD).' }
                    }
                },
                {
                    name: 'Fire',
                    ...
                    sets: {
                        ...
                        t5: { name: 'Tirisfal Regalia', image: 'https://imgur.com/bB9E1wK.jpeg', bonus: '**2-Set:** Increases the damage and mana cost of your Arcane Blast by 20%.\n**4-Set:** Your Spell critical strikes grant you up to 70 spell power for 6 sec.' },
                        t6: { name: 'Tempest Regalia', image: 'https://imgur.com/bB9E1wK.jpeg', bonus: '**2-Set:** Increases the duration of your Evocation ability by 2 sec.\n**4-Set:** Increases the damage of your Fireball, Frostbolt, and Arcane Missiles abilities by 5%.' },
                        't6.5': { name: 'Garb of the Arcane Order', image: 'https://i.imgur.com/ZmtFvSD.jpeg', bonus: '**2-Set:** Hot Streak proc chance increased by 10%.\n**4-Set:** Living Bomb explosion damage increased by 20%.' },
                        t1: { name: 'Arcanist Garb (Reforged)', image: 'https://imgur.com/bB9E1wK.jpeg', bonus: '**2-Set:** **Phoenix Flames:** Fire Blast has 3 charges and always crits.\n**4-Set:** **From the Ashes:** Increases Mastery by 5% for each charge of Fire Blast on cooldown.' },
                        t2: { name: 'Netherwind Garb (Reforged)', image: 'https://imgur.com/bB9E1wK.jpeg', bonus: '**2-Set:** **Sun King\'s Blessing:** Consuming a Hot Streak has a chance to make your next Pyroblast instant and deal 50% increased damage.\n**4-Set:** **Kindling:** Critical strikes reduce the cooldown of Combustion by 1 sec.' },
                        t3: { name: 'Frostfire Garb (Reforged)', image: 'https://imgur.com/bB9E1wK.jpeg', bonus: '**2-Set:** **Hyperthermia:** Hot Streak has a chance to activate Hyperthermia, making all Pyroblasts instant for 5 seconds.\n**4-Set:** **Meteor:** Calls down a meteor that hits for massive Fire damage split between targets.' }
                    }
                },
                {
                    name: 'Frost',
                    ...
                    sets: {
                        ...
                        t5: { name: 'Tirisfal Regalia', image: 'https://imgur.com/bB9E1wK.jpeg', bonus: '**2-Set:** Increases the damage and mana cost of your Arcane Blast by 20%.\n**4-Set:** Your Spell critical strikes grant you up to 70 spell power for 6 sec.' },
                        t6: { name: 'Tempest Regalia', image: 'https://imgur.com/bB9E1wK.jpeg', bonus: '**2-Set:** Increases the duration of your Evocation ability by 2 sec.\n**4-Set:** Increases the damage of your Fireball, Frostbolt, and Arcane Missiles abilities by 5%.' },
                        't6.5': { name: 'Vestments of the Arcane Order', image: 'https://i.imgur.com/ZmtFvSD.jpeg', bonus: '**2-Set:** Brain Freeze proc chance increased by 15%.\n**4-Set:** Deep Freeze damage increased by 20%.' },
                        t1: { name: 'Arcanist Vestments (Reforged)', image: 'https://imgur.com/bB9E1wK.jpeg', bonus: '**2-Set:** **Chain Reaction:** Frostbolt crits increase the damage of your next Ice Lance by 10% (stacks 5 times).\n**4-Set:** **Glacial Spike:** Consumes 5 Icicles to launch a massive spike dealing 300% spell power.' },
                        t2: { name: 'Netherwind Vestments (Reforged)', image: 'https://imgur.com/bB9E1wK.jpeg', bonus: '**2-Set:** **Frozen Orb:** Replaces Frost Ward. Launches an orb of swirling ice that damages and slows enemies.\n**4-Set:** **Freezing Rain:** Frozen Orb makes Blizzard instant cast and deal 50% more damage.' },
                        t3: { name: 'Frostfire Vestments (Reforged)', image: 'https://imgur.com/bB9E1wK.jpeg', bonus: '**2-Set:** **Comet Storm:** Calls down 7 comets to impact the target area.\n**4-Set:** **Ray of Frost:** Channel a beam of ice that deals increasing damage over 6 seconds.' }
                    }
                }
            ]
        },
            ...
            specs: [
                {
                    ...
                    sets: {
                        t4: { name: 'Voidheart Raiment', image: 'https://imgur.com/cC9F1wK.jpeg', bonus: '**2-Set:** Your shadow damage spells have a chance to grant you 135 bonus shadow damage for 15 sec.\n**4-Set:** Increases the duration of your Corruption and Immolate abilities by 3 sec.' },
                        t5: { name: 'Corruptor Raiment', image: 'https://imgur.com/cC9F1wK.jpeg', bonus: '**2-Set:** Your pet heals you for 15% of the damage it deals.\n**4-Set:** Your Shadow Bolt hits have a chance to grant you 270 spell damage for 10 sec.' },
                        t6: { name: 'Malefic Raiment', image: 'https://imgur.com/cC9F1wK.jpeg', bonus: '**2-Set:** Each time one of your corruption or immolate ticks deals damage you heal for 70 health.\n**4-Set:** Increases the damage dealt by your Shadow Bolt and Incinerate abilities by 6%.' },
                        't6.5': { name: 'Raiment of the Dark Conclave', image: 'https://i.imgur.com/9IU77eZ.jpeg', bonus: '**2-Set:** Unstable Affliction damage increased by 10%.\n**4-Set:** Haunt cooldown reduced by 2 sec.' },
                        t1: { name: 'Felheart Raiment (Reforged)', image: 'https://imgur.com/cC9F1wK.jpeg', bonus: '**2-Set:** **Malefic Rapture:** Drain Soul now hits all targets affected by your Corruption for 50% damage.\n**4-Set:** **Soul Rot:** Withers away all life within 10yds, applying a heavy DoT.' },
                        t2: { name: 'Nemesis Raiment (Reforged)', image: 'https://imgur.com/cC9F1wK.jpeg', bonus: '**2-Set:** **Absolute Corruption:** Corruption is now permanent on non-player targets.\n**4-Set:** **Creeping Death:** Your DoTs deal their damage 15% faster.' },
                        t3: { name: 'Plagueheart Raiment (Reforged)', image: 'https://imgur.com/cC9F1wK.jpeg', bonus: '**2-Set:** **Deathbolt:** Fires a bolt of death dealing 30% of remaining DoT damage on the target instantly.\n**4-Set:** **Darkglare:** Summon a Darkglare that extends the duration of your DoTs by 8 sec.' }
                    }
                },
                {
                    name: 'Demonology',
                    ...
                    sets: {
                        ...
                        t5: { name: 'Corruptor Raiment', image: 'https://imgur.com/cC9F1wK.jpeg', bonus: '**2-Set:** Your pet heals you for 15% of the damage it deals.\n**4-Set:** Your Shadow Bolt hits have a chance to grant you 270 spell damage for 10 sec.' },
                        t6: { name: 'Malefic Raiment', image: 'https://imgur.com/cC9F1wK.jpeg', bonus: '**2-Set:** Each time one of your corruption or immolate ticks deals damage you heal for 70 health.\n**4-Set:** Increases the damage dealt by your Shadow Bolt and Incinerate abilities by 6%.' },
                        't6.5': { name: 'Robes of the Dark Conclave', image: 'https://i.imgur.com/9IU77eZ.jpeg', bonus: '**2-Set:** Felguard attack speed increased by 10%.\n**4-Set:** Chaos Bolt pierces shields and ignores absorption effects.' },
                        t1: { name: 'Felheart Robes (Reforged)', image: 'https://imgur.com/cC9F1wK.jpeg', bonus: '**2-Set:** **Dreadstalkers:** Curse of Doom summons 2 Dreadstalkers when it detonates.\n**4-Set:** **Demonic Calling:** Shadow Bolt has a chance to make your next Summon Demon instant and free.' },
                        t2: { name: 'Nemesis Robes (Reforged)', image: 'https://imgur.com/cC9F1wK.jpeg', bonus: '**2-Set:** **Hand of Gul\'dan:** Shadowfury also summons a meteor that spawns 3 Wild Imps.\n**4-Set:** **Implosion:** Detonate all your Wild Imps to deal massive AoE damage.' },
                        t3: { name: 'Plagueheart Robes (Reforged)', image: 'https://imgur.com/cC9F1wK.jpeg', bonus: '**2-Set:** **Power Siphon:** Sacrifice 2 Imps to gain 2 stacks of "Demonic Core" (Instant Shadow Bolt/Incinerate).\n**4-Set:** **Demonic Tyrant:** Summon a Demonic Tyrant that extends the duration of all your other demons.' }
                    }
                },
                {
                    name: 'Destruction',
                    ...
                    sets: {
                        ...
                        t5: { name: 'Corruptor Raiment', image: 'https://imgur.com/cC9F1wK.jpeg', bonus: '**2-Set:** Your pet heals you for 15% of the damage it deals.\n**4-Set:** Your Shadow Bolt hits have a chance to grant you 270 spell damage for 10 sec.' },
                        t6: { name: 'Malefic Raiment', image: 'https://imgur.com/cC9F1wK.jpeg', bonus: '**2-Set:** Each time one of your corruption or immolate ticks deals damage you heal for 70 health.\n**4-Set:** Increases the damage dealt by your Shadow Bolt and Incinerate abilities by 6%.' },
                        't6.5': { name: 'Vestments of the Dark Conclave', image: 'https://i.imgur.com/9IU77eZ.jpeg', bonus: '**2-Set:** Searing Pain has 100% crit chance on targets below 50% HP.\n**4-Set:** Shadowburn resets its cooldown on kill.' },
                        t1: { name: 'Felheart Vestments (Reforged)', image: 'https://imgur.com/cC9F1wK.jpeg', bonus: '**2-Set:** **Havoc:** Bane of Havoc copies single target spells to a second target for 10 sec.\n**4-Set:** **Backdraft:** Conflagrate reduces the cast time of Chaos Bolt and Incinerate by 30%.' },
                        t2: { name: 'Nemesis Vestments (Reforged)', image: 'https://imgur.com/cC9F1wK.jpeg', bonus: '**2-Set:** **Cataclysm:** Cast a massive AoE that applies Immolate to all targets hit.\n**4-Set:** **Fire and Brimstone:** Incinerate now hits all targets affected by your Immolate.' },
                        t3: { name: 'Plagueheart Vestments (Reforged)', image: 'https://imgur.com/cC9F1wK.jpeg', bonus: '**2-Set:** **Channel Demonfire:** Channel 15 bolts of fel fire at random targets affected by Immolate.\n**4-Set:** **Chaos Reach:** Chaos Bolt range increased by 20 yds and castable while moving.' }
                    }
                }
            ]
        },
                    ...
                    <div className="flex-grow animate-fade-in">
                        ...
                        <div className="mb-8 border-b border-white/10 pb-6">
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <div>
                                    <h2 className="font-cinzel text-4xl text-white">{currentClass.name} Armory</h2>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-2">
                                {tiers.map((tier) => (
                                    <button
                                        ...
                                        className={`flex flex-col items-center justify-center p-3 rounded border transition-all ${activeTier === tier.id
                                            ? 'bg-amber-900/20 border-amber-500/50 shadow-[0_0_15px_rgba(245,158,11,0.1)]'
                                            : 'bg-[#111] border-white/5 hover:border-white/20'}`}
                                    >
                                        <span className={`font-cinzel font-bold text-sm ${activeTier === tier.id ? 'text-amber-500' : 'text-stone-400'}`}>{tier.label}</span>
                                        <span className="text-[10px] text-stone-600 uppercase tracking-tight">{tier.sub.split(' ')[0]}</span>
                                    </button>
                                ))}
                            </div>
                        </div>
                        ...
                        {currentSet ? (
                            <div className="bg-[#0a0a0a] rounded-xl overflow-hidden border border-white/10 shadow-2xl relative group">
                                ...
                                <div className="flex flex-col md:flex-row">
                                    <div className="md:w-1/3 min-h-[300px] relative bg-[#111] overflow-hidden">
                                        <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')] opacity-20"></div>
                                        <div className="absolute inset-0 flex items-center justify-center">
                                            <span className="font-cinzel text-8xl font-black text-white/5 select-none">{activeTier.toUpperCase()}</span>
                                        </div>
                                        {/* IMAGE PLACEHOLDER - Would be replaced by real set images */}
                                        <img src={currentSet.image} alt={currentSet.name} className="absolute inset-0 w-full h-full object-contain" />
                                        <div className="absolute bottom-4 left-4">
                                            <div className="flex items-center gap-2 text-stone-400 bg-black/80 px-3 py-1 rounded-full border border-white/10 text-xs shadow-xl">
                                                <LayoutGrid size={12} />
                                    ...
                                    <div className="md:w-2/3 p-8 relative z-10">
                                        <div className="border-b border-white/10 pb-4 mb-6">
                                            <h3 className="font-cinzel text-3xl text-white mb-2">{currentSet.name}</h3>
                                            <div className="flex items-center gap-2 text-sm">
                                                <span className={`px-2 py-0.5 rounded bg-amber-900/20 text-amber-500 border border-amber-500/20`}>Legendary Battlegear</span>
                                        ...
                                        <div className="space-y-6">
                                            <div className="bg-[#111] p-6 rounded-lg border border-white/5 relative overflow-hidden">
                                            ...
                                            <div className="grid grid-cols-2 gap-4">
                                                <div className="p-3 bg-white/5 rounded border border-white/5">
                                                    <span className="block text-xs text-stone-500 uppercase">Token Source</span>
                                                    <span className="text-stone-300 text-sm">{tiers.find(t => t.id === activeTier)?.sub || 'Raid Drop'}</span>
                                                </div>
                                                <div className="p-3 bg-white/5 rounded border border-white/5">
                                                    <span className="block text-xs text-stone-500 uppercase">Specialization</span>
                                                    <span className="text-stone-300 text-sm">{currentClass.specs[activeSpec].name}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="flex flex-col items-center justify-center p-20 text-stone-600 border border-dashed border-stone-800 rounded-xl bg-[#0a0a0a]">
                                <Clock size={48} className="mb-4 opacity-50" />
                                <h3 className="font-cinzel text-xl mb-2">Data Unearthed Soon</h3>
                                <p className="text-sm">This artifact has not yet been chronicled.</p>
                            </div>
                        )}
                    </div>
                </div>
