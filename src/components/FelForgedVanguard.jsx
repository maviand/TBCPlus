      ...
      items: [
        {
          ...
          icon: <img src={import.meta.env.BASE_URL + "images/art/class_warrior.png"} className="w-8 h-8 object-contain scale-125" alt="Warrior" />,
        ...
        },
        {
          ...
          icon: <img src={import.meta.env.BASE_URL + "images/art/class_paladin.png"} className="w-8 h-8 object-contain scale-125" alt="Paladin" />,
        ...
        },
        {
          ...
          icon: <img src={import.meta.env.BASE_URL + "images/art/class_hunter.png"} className="w-8 h-8 object-contain scale-125" alt="Hunter" />,
        ...
        },
        {
          ...
          icon: <img src={import.meta.env.BASE_URL + "images/art/class_rogue.png"} className="w-8 h-8 object-contain scale-125" alt="Rogue" />,
        ...
        },
        {
          ...
          icon: <img src={import.meta.env.BASE_URL + "images/art/class_priest.png"} className="w-8 h-8 object-contain scale-125" alt="Priest" />,
        ...
        },
        {
          ...
          icon: <img src={import.meta.env.BASE_URL + "images/art/class_mage.png"} className="w-8 h-8 object-contain scale-125" alt="Mage" />,
        ...
        },
        {
          ...
          icon: <img src={import.meta.env.BASE_URL + "images/art/class_warlock.png"} className="w-8 h-8 object-contain scale-125" alt="Warlock" />,
        ...
        },
        {
          ...
          icon: <img src={import.meta.env.BASE_URL + "images/art/class_shaman.png"} className="w-8 h-8 object-contain scale-125" alt="Shaman" />,
        ...
        },
        {
          ...
          icon: <img src={import.meta.env.BASE_URL + "images/art/class_druid.png"} className="w-8 h-8 object-contain scale-125" alt="Druid" />,
